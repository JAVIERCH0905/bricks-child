				...
				if ( $image_url ) {
					...
					if ( isset( $settings['adaptiveHeight'] ) ) {
						...
						if ( $type === 'media' && isset( $settings['imageLightbox'] ) ) {
							...
							$image_atts['data-bricks-lightbox-source'] = $lightbox_image_src[0];
							$image_atts['data-bricks-lightbox-width']  = $lightbox_image_src[1];
							$image_atts['data-bricks-lightbox-height'] = $lightbox_image_src[2];
						}
					...
					// Use background image
						...
						if ( $type === 'media' && isset( $settings['imageLightbox'] ) ) {
							...
							$this->set_attribute( "image-$item_index", 'data-bricks-lightbox-source', $lightbox_image_src[0] );
							$this->set_attribute( "image-$item_index", 'data-bricks-lightbox-width', $lightbox_image_src[1] );
							$this->set_attribute( "image-$item_index", 'data-bricks-lightbox-height', $lightbox_image_src[2] );
